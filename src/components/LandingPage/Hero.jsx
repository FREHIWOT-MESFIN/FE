...
const Hero = () => {
  return (
    <section className="w-full lg:h-[100vh] flex flex-col lg:flex-row items-center lg:items-start  justify-center mt-[0.5625rem] gap-[4.25rem]">
      {/**mt-[10rem] md:mt-[15rem] lg:mt-[0.5625rem] */}
    {/* Main Content Section */}
    <div className="w-[30rem] md:w-[45rem] lg:w-[33.75rem] h-auto gap-[1.5rem] pt-[5rem]">
     {/* Heading */}
      ...
      {/* Buttons */}
      <div className="w-full flex  justify-center items-center gap-[1rem] mt-3">
        <button className="relative font-[Inter] text-[0.875rem] text-[#fff] font-semibold leading-[1.25rem] text-center bg-[#417BEB] shadow-[0px_1px_2px_0px_#0000001D] w-[10.1875rem] h-[2.75rem] px-[18px] py-[14px] gap-[8px] rounded-[16px]">
          Book Appointment
              {/* Vector Image */}
        ...
        <button className="flex relative font-[Inter] text-[0.875rem] font-semibold leading-[1.25rem] text-center shadow-[0px_0.0625rem_0.125rem_0px_#0000001D] w-[8.5625rem] h-[2.75rem] px-[1.125rem] py-[0.9375rem] gap-[0.5rem] rounded-[1rem]">
          Learn more
    ...
    <div className="relative w-[23rem] md:w-[36.6875rem] sm:h-[20.878rem] md:h-auto gap-0 sm:gap-0 z-[-1]">
      ...
      <div className="w-auto h-auto gap-[0.625rem]">
        <div className="absolute bg-[#fff] flex items-center top-[15rem] md:top-[27.24rem] right-[-1rem] w-[7.125rem] h-[2.5625rem] gap-[0.625rem] rounded-[1.6875rem] border-b border-transparent shadow-[0px_0px_1.08125rem_-0.1875rem_rgba(0,0,0,0.36)]">
          <div className="w-[3.0625rem] h-[2.5625rem] p-[0.75rem] [padding-left:0.875rem] [padding-right:0.875rem] gap-[0.625rem] rounded-[9.9375rem] bg-[#D9E5FB] flex items-center justify-center">
            <span className="font-[Inter] text-[0.75rem] font-medium leading-[1.0875rem] text-[#417BEB]">
              1K+
            </span>
